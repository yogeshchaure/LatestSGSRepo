...
// ---    Mon Oct 17 06:40:50 IST 2022
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SgsIcoBeforeAllocationImpl extends EntityImpl {
    /**
    ...
    private static final ADFLogger LOG = ADFLogger.createADFLogger(SgsIcoBeforeAllocationImpl.class);
    public static final int BAID = AttributesEnum.BaId.index();
     ...
     */
    public SgsIcoBeforeAllocationImpl() {
    }

    /**
     * Gets the attribute value for BaId, using the alias name BaId.
     * @return the value of BaId
     */
    public Integer getBaId() {
        return (Integer) getAttributeInternal(BAID);
    }

    /**
     * Sets <code>value</code> as the attribute value for BaId.
     * @param value value to set the BaId
     */
    public void setBaId(Integer value) {
        setAttributeInternal(BAID, value);
    }
    ...
    /**
     * @param baId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Integer baId) {
        return new Key(new Object[] { baId });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.sgs.model.entity.SgsIcoBeforeAllocation");
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        try {
            ...
            setBaId(am.getDBSequence("SGS_ICO_BEFORE_ALLOCATION_SEQ"));
        } catch (Exception e) {
            LOG.severe(e);
        }
    }
